...
const config = [
	...
	},
	{
		...
		files: ["src/**/*.ts"],
		rules: {
			// As middleware, this project should never use a console.log statement;
			// instead, rely on emitting events and allow consuming code to decide
			// whether a log is necessary.
			"no-console": "error",
		},
	},
	{
